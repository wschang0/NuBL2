...
//CWS #error "FLASH_AREA_0_OFFSET must be defined by the target"
#endif

#ifndef FLASH_AREA_0_SIZE
//CWS #error "FLASH_AREA_0_SIZE must be defined by the target"
#endif

#ifndef FLASH_AREA_2_OFFSET
//CWS #error "FLASH_AREA_2_OFFSET must be defined by the target"
#endif

#ifndef FLASH_AREA_2_SIZE
//CWS #error "FLASH_AREA_2_SIZE must be defined by the target"
#endif
...
//CWS #error "FLASH_AREA_SCRATCH_OFFSET must be defined by the target"
#endif

#ifndef FLASH_AREA_SCRATCH_SIZE
//CWS #error "FLASH_AREA_SCRATCH_SIZE must be defined by the target"
#endif

#ifndef FLASH_DEV_NAME
//CWS #error "BL2 supports CMSIS flash interface and device name must be specified"
#endif

#ifndef BOOT_STATUS_MAX_ENTRIES
//CWS #error "BOOT_STATUS_MAX_ENTRIES must be defined by the target"
#endif

#ifndef BOOT_MAX_IMG_SECTORS
//CWS #error "BOOT_MAX_IMG_SECTORS must be defined by the target"
#endif
