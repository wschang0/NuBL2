@REM tfm_split ..\..\..\..\..\..\trusted-firmware-m\build\unit_test\tfm_s.bin ..\..\..\..\..\..\trusted-firmware-m\build\unit_test\tfm_s.map
tfm_split ..\..\..\..\..\..\trusted-firmware-m\build\secure_fw\tfm_s.bin ..\..\..\..\..\..\trusted-firmware-m\build\secure_fw\tfm_s.map
